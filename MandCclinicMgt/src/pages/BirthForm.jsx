            ...
            <Box mt={6}>
              <Grid2 container spacing={4}>
                ...
                <Grid2 item xs={12} display="flex" justifyContent="flex-end" spacing={2} sx={{ml:100, height:40 }}>
                  <Button onClick={() => alert("Saved Successfully")} variant="contained" sx={{ width:200,backgroundColor: pink[300], marginRight: 1, textTransform: "none", }}>Save</Button>
                  <Button onClick={() => navigate("/babycart")} variant="contained" sx={{ width:200, backgroundColor: pink[500], textTransform: "none" }}>Back</Button>
                </Grid2>
              </Grid2>
            </Box>
          </CardContent>
