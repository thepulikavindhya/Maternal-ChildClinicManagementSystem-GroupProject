      ...
      >
        ...
        <CardContent>
          <Stack spacing={2} mt={4}>
            <Typography variant="body2">Mothers ID:</Typography>
            <Typography variant="body2">Babys Name:</Typography>
            ...
            <Typography variant="body2">Mothers Name:</Typography>
            <Typography variant="body2">Mothers Birthdate:</Typography>
