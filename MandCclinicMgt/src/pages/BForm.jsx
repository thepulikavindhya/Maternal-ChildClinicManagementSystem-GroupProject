      ...
      <Card sx={{ maxWidth: 600, width: "100%", borderRadius: 4, boxShadow: 3, textAlign: "left", padding: 2 }}>
        ...
        <CardContent>
          ...
          <Stack direction="row" spacing={2} justifyContent="center" mt={2}>
            ...
            <Button variant="contained" color="error" sx={{ borderRadius: 3, textTransform: "none", bgcolor: "#FFC0E5", color: "#000000", width: "200px" }}>
              Remove
            </Button>
            <Button variant="contained" color="secondary" sx={{ borderRadius: 3, textTransform: "none", bgcolor: "#FFC0E5", color: "#000000", width: "200px" }}>
              Reminder
            </Button>
          </Stack>
        </CardContent>
